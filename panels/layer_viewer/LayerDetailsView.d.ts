...
declare const LayerDetailsView_base: (new (...args: any[]) => {
    ...
    dispatchEventToListeners<T_3 extends Events.PaintProfilerRequested>(eventType: Platform.TypeScriptUtilities.NoUnion<T_3>, ...eventData: Common.EventTarget.EventPayloadToRestParameters<Common.EventTarget.EventPayload<EventTypes, T_3>>): void; /**
