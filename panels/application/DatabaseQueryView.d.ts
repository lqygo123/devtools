...
declare const DatabaseQueryView_base: (new (...args: any[]) => {
    ...
    addEventListener<T extends Events.SchemaUpdated>(eventType: T, listener: (arg0: Common.EventTarget.EventTargetEvent<Common.EventTarget.EventPayload<EventTypes, T>>) => void, thisObject?: Object | undefined): Common.EventTarget.EventDescriptor<EventTypes, T>;
    once<T_1 extends Events.SchemaUpdated>(eventType: T_1): Promise<Common.EventTarget.EventPayload<EventTypes, T_1>>;
    removeEventListener<T_2 extends Events.SchemaUpdated>(eventType: T_2, listener: (arg0: Common.EventTarget.EventTargetEvent<Common.EventTarget.EventPayload<EventTypes, T_2>>) => void, thisObject?: Object | undefined): void;
    hasEventListeners(eventType: Events.SchemaUpdated): boolean;
    dispatchEventToListeners<T_3 extends Events.SchemaUpdated>(eventType: import("../../core/platform/typescript-utilities.js").NoUnion<T_3>, ...eventData: Common.EventTarget.EventPayloadToRestParameters<Common.EventTarget.EventPayload<EventTypes, T_3>>): void;
